...
return [
    ...
    'Setup SMTP or use SendPulse' => 'Настройте SMTP или используйте SendPulse',
    ...
    'Middle copy size of uploaded image' => 'Размер средней копии загруженного изображения',
    'Big copy size of uploaded image' => 'Размер большой копии загруженного изображения',
    ...
    'hours' => 'часов',
    'Enable Publications' => 'Включить публикации',
    'Ability to publish posts by category' => 'Возможность публикации постов по категориям',
    'Enable Pages' => 'Включить страницы',
    'Ability to add pages' => 'Возможность добавления страниц.',
    ...
    'Allow Methods' => 'Разрешить методы',
    'Allow Headers' => 'Разрешить заголовки',
    'Allow Origin' => 'Разрешить origin',
    'Turning SendPulse on and off' => 'Включение и выключение SendPulse',
    ...
    'Only latin letters are allowed: <code>[A-Za-z0-9]</code>' => 'Допустимы только латинские буквы: <code>[A-Za-z0-9]</code>',
];
